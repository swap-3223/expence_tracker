...
//   return (
//     <section className="min-h-screen mt-15 from-gray-900 via-gray-800 to-gray-900 text-white flex flex-col">
     
//      {/* Greeting */}
          
//       {/* Hero Section */}
//       <div className="flex flex-col md:flex-row justify-between items-center  px-10 md:px-20 py-15">
...
//               Manage your{" "}
//               <span
//                 className="text-transparent bg-clip-text  from-blue-400 to-purple-500 
...
const Home = () => {
  ...
  return (
    <section className="min-h-screen bg-linear-to-b mt-10 from-gray-900 via-gray-800 to-gray-900 text-white flex flex-col">
